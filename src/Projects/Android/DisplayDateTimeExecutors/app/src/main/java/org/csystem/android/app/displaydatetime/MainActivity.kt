/*--------------------------------------------------------------------------------------------------
Thread yaratıldı havuza atıldı ve oradan kullanılıyor
--------------------------------------------------------------------------------------------------*/
...
class MainActivity : AppCompatActivity()
{
    ...
    private lateinit var mDateTimeScheduledFuture:ScheduledFuture<*> // bir sonuç elde etmeyeceğim için any (*) verdik
    private lateinit var mChronoScheduledFuture:ScheduledFuture<*> // bir sonuç elde etmeyeceğim için any (*) verdik
    ...
    override fun onStop()
    {
        try {
            ...
            mClockFuture.cancel(true) // sistemi sonlandırmak istersek true geçmeliyiz,
            // false geçersek flag değerinin değiştiğini anlayamaz
            super.onStop()
        }catch (ex:Throwable){
    ...
    {
        // singleThreadExecutor.shutdown() // thread havuzunu kapatır ve dolayısıyla uygulama tekrar
        // onStart olunca uygulama çöker
        super.onDestroy()
    }
